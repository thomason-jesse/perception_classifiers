...
The vast majority of existing work to connect language with robot perception is limited to vision.
We build perceptual models use visual, haptic, auditory, and proprioceptive data acquired through robot exploratory behaviors that go beyond vision.
