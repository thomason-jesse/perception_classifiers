...
The \textbf{vision only} system seems able to ground ``heavy'' in height and ``small'' in width, the latter of which is a visual word-property pair (though ``heavy'' for height has counter-examples in our dataset).
